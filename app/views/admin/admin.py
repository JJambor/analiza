...
update_sheet_bp = Blueprint('update_sheet', __name__)
@admin_root_bp.route('/')
def admin_root():
...
@update_sheet_bp.route("/datasheets/update-sheet", methods=['POST'])
def update_sheet():
    return AdminController.update_sheet(request.form.getlist("id"), request.form.get("action"))
